...
const Navbar: FC = () => {
  ...
  return (
    <nav className="col-span-full fixed z-50 flex w-full items-center justify-between gap-2 px-6 py-4 bg-gradient-to-b from-black to-background-opacity-0 md:gap-3 md:py-12 md:px-16">
